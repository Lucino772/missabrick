...
})({"khvVw":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "bb3e28cd6f5ee655";
...
var _setCard = require("./SetCard");
var _setCardDefault = parcelHelpers.interopDefault(_setCard);
(0, _preactCustomElementDefault.default)((0, _dropzoneDefault.default), "x-dropzone", []);
(0, _preactCustomElementDefault.default)((0, _setCardDefault.default), "x-set-card", [
    "title",
    "theme",
    "num_parts",
    "year",
...
},{"preact-custom-element":"j5zGl","./Dropzone":"7JGys","./SetCard":"1LQAL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"j5zGl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function i(t1) {
    ...
    var e1 = t1.children, n1 = function(t, e) {
        if (null == t) return {};
        var n, o, r1 = {}, i1 = Object.keys(t);
        for(o = 0; o < i1.length; o++)e.indexOf(n = i1[o]) >= 0 || (r1[n] = t[n]);
        return r1;
    }(t1, [
        "context",
        "children"
    ]);
    return (0, _preact.cloneElement)(e1, n1);
}
function a() {
    var o1 = new CustomEvent("_preact", {
        detail: {},
        bubbles: !0,
        cancelable: !0
    });
    this.dispatchEvent(o1), this._vdom = (0, _preact.h)(i, r({}, this._props, {
        context: o1.detail.context
    }), function e(n, o) {
        if (3 === n.nodeType) return n.data;
        if (1 !== n.nodeType) return null;
        var r2 = [], i2 = {}, a1 = 0, c1 = n.attributes, l1 = n.childNodes;
        for(a1 = c1.length; a1--;)"slot" !== c1[a1].name && (i2[c1[a1].name] = c1[a1].value, i2[s(c1[a1].name)] = c1[a1].value);
        for(a1 = l1.length; a1--;){
            var p = e(l1[a1], null), d = l1[a1].slot;
            d ? i2[d] = (0, _preact.h)(u, {
                name: d
            }, p) : r2[a1] = p;
        }
        var h = o ? (0, _preact.h)(u, null, r2) : r2;
        return (0, _preact.h)(o || n.nodeName.toLowerCase(), i2, h);
...
function c(t, e, r3) {
    if (this._vdom) {
        var i3 = {};
        i3[t] = r3 = null == r3 ? void 0 : r3, i3[s(t)] = r3, this._vdom = (0, _preact.cloneElement)(this._vdom, i3), (0, _preact.render)(this._vdom, this._root);
    }
}
function l() {
...
function u(e, n) {
    ...
    return (0, _preact.h)("slot", r({}, e, {
        ref: function(t2) {
            t2 ? (o.ref = t2, o._listener || (o._listener = function(t) {
                t.stopPropagation(), t.detail.context = n;
            }, t2.addEventListener("_preact", o._listener))) : o.ref.removeEventListener("_preact", o._listener);
        }
    }));
}
exports.default = function(t3, e2, n2, o) {
    function r4() {
        var e = Reflect.construct(HTMLElement, [], r4);
        return e._vdomComponent = t3, e._root = o && o.shadow ? e.attachShadow({
            mode: "open"
        }) : e, e;
    }
    return (r4.prototype = Object.create(HTMLElement.prototype)).constructor = r4, r4.prototype.connectedCallback = a, r4.prototype.attributeChangedCallback = c, r4.prototype.disconnectedCallback = l, n2 = n2 || t3.observedAttributes || Object.keys(t3.propTypes || {}), r4.observedAttributes = n2, n2.forEach(function(t) {
        Object.defineProperty(r4.prototype, t, {
            get: function() {
    ...
    }), customElements.define(e2 || t3.tagName || t3.displayName || t3.name, r4);
};
...
},{}],"7JGys":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
                    ...
                    children: [
                        /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("svg", {
                            ...
                            children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("path", {
                                ...
                                fileName: "components/Dropzone.jsx",
                                lineNumber: 13,
                                columnNumber: 152
                            }, undefined)
                        }, void 0, false, {
...
},{"preact/jsx-dev-runtime":"3mFUL","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3mFUL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"preact":"26zcy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
...
},{"./../utils":"5By4s"}],"1LQAL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _jsxDevRuntime = require("preact/jsx-dev-runtime");
const SetCard = ({ title ="This is a set" , theme ="Theme" , num_parts =540 , year =2000 , description ="lorem ipsum"  })=>{
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
        class: "flex flex-row py-4 gap-4",
        children: [
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("img", {
                class: "w-20 h-20 rounded-xl object-cover border border-white",
                src: "https://img.redbull.com/images/c_limit,w_1500,h_1000,f_auto,q_auto/redbullcom/2022/1/28/jnuookfhjrooziqpigvq/lego-art",
                alt: ""
            }, void 0, false, {
                fileName: "components/SetCard.jsx",
                lineNumber: 4,
                columnNumber: 13
            }, undefined),
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("a", {
                        ...
                        children: "9493-1 : Le retour du Jedi"
                    }, void 0, false, {
                        fileName: "components/SetCard.jsx",
                        lineNumber: 6,
                        columnNumber: 17
                    ...
                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("span", {
                        ...
                        children: "Star Wars - 540 parts - 1998"
                    }, void 0, false, {
                        fileName: "components/SetCard.jsx",
                        lineNumber: 7,
                        columnNumber: 17
...
},{"preact/jsx-dev-runtime":"3mFUL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["khvVw","ePLYF"], "ePLYF", "parcelRequire94c2")
