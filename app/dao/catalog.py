...
part_category_dao = PartCategoryDao()
part_relationship_dao = PartRelationshipDao()
part_dao = PartDao()
set_dao = SetDao()
inventory_dao = InventoryDao()
inv_minifig_dao = InventoryMinifigDao()
inv_set_dao = InventorySetDao()
theme_dao = ThemeDao()
element_dao = ElementDao()
color_dao = ColorDao()
minifig_dao = MinifigDao()
inv_part_dao = InventoryPartDao()
